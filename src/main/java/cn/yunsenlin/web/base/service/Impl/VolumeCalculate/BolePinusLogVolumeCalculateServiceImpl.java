...
import cn.yunsenlin.web.base.dao.BolePinusLogCalculateRecordMapper;
...
public class BolePinusLogVolumeCalculateServiceImpl implements LogVolumeCalculateService{
    private final BolePinusLogCalculateRecordMapper bolePinusLogCalculateRecordMapper;
    ...
    public BolePinusLogVolumeCalculateServiceImpl(BolePinusLogCalculateRecordMapper bolePinusLogCalculateRecordMapper) {
        this.bolePinusLogCalculateRecordMapper = bolePinusLogCalculateRecordMapper;
    }
    ...
    public BigDecimal getVolumeCalculateResult(BigDecimal length, BigDecimal diameter) {
        ...
        if (length.compareTo(num5) >= 0
            ...
            logger.info("当前的马尾松原条的计算方案和杉原条是一样的");
        ...
        try {
            if (volume.compareTo(BigDecimalFactory.get("-1"))==0){
                ...
                bolePinusLogCalculateRecordMapper.insert(
                        new BolePinusLogCalculateRecord(
